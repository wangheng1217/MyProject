...
public class MergeKSortedListsSolution {
    public ListNode mergeKLists(List<ListNode> lists) {
        ...
        PriorityQueue<ListNode> heap = new PriorityQueue<ListNode>(c);
//        PriorityQueue<ListNode> heap = new PriorityQueue<ListNode>(lists.size()+1, c);
        ...
        if (heap.size() == 1) pre.next = heap.poll();
    ...
    public ListNode mergeKLists3(ArrayList<ListNode> lists) {
        ...
        // jdk 1.8 has a new constructor PriorityQueue(Comparator<? super E> comparator)
