...
public class MultiplyStringsSolution {
    ...
    public String multiply0(String num1, String num2) {
        ...
        for (int i = num2.length()-1; i >= 0; i--) {
            ...
            if (digit == '0') continue;
            String m = multiply(num1, digit);
            m = leftShift(m, num2.length()-1-i);
            result = add(result, m);
        }
        return result;
    }
    ...
    private String multiply(String num, char digit) {
        ...
        for (int i = num.length()-1; i >= 0; i--) {
            int m = n * getInt(num.charAt(i)) + carry;
            carry = m/10;
            sb.append(m%10);
        }
    ...
    private String leftShift(String num, int n) {
    ...
    private String add(String num1, String num2) {
        ...
        while (i >= 0 || j >= 0 || carry > 0) {
            int sum = 0;
            if (i >= 0) {
                sum = sum + getInt(num1.charAt(i));
                i--;
            }
            if (j >= 0) {
                sum = sum + getInt(num2.charAt(j));
                j--;
            }
            sum = sum + carry;
            carry = sum/10;
